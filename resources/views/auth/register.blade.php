...
<body class="off-canvas-sidebar">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <i class="material-icons" style="color: #36a18b">face</i>
                                                </span>
                                            </div>
                                    ...
                                    <span class="bmd-form-group">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <i class="material-icons" style="color: #36a18b">vpn_key</i>
                                                </span>
                                            </div>
    ...
    <script async defer src="{{ asset('media/admin/buttons.github.io/buttons.js') }}"></script>
    <script src="{{ asset('media/admin/js/plugins/chartist.min.js') }}"></script>
    <!--  Notifications Plugin    -->
    <script src="{{ asset('media/admin/js/plugins/bootstrap-notify.js') }}"></script>
